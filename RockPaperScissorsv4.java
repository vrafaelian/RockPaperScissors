...
public class RockPaperScissorsv4 extends Application {
  ...
  public void start(Stage primaryStage) throws FileNotFoundException {
    ...
    comprock.setX(280);
    comprock.setY(120);
    comprock.setFitHeight(400);
    comprock.setFitWidth(200);
    ...
    comppaper.setX(280);
    comppaper.setY(100);
    comppaper.setFitHeight(400);
    comppaper.setFitWidth(200);
    ...
    compscissors.setX(280);
    compscissors.setY(100);
    compscissors.setFitHeight(400);
    compscissors.setFitWidth(200);
  ...
  public boolean youWinLose() {

    Text youLost = new Text();
    youLost.setX(380);
    youLost.setY(200);
